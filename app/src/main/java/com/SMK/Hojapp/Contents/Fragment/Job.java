 ...
 * 마켓 카테고리
 */
public class Job extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    final String TAG = "Job";
    final String nameOfCategory = "알바 구하기"; // DB에 저장되는 카테고리 이름
