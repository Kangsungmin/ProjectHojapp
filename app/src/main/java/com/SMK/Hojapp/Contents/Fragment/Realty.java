 ...
 * 마켓 카테고리
 */
public class Realty extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    final String TAG = "Realty";
    final String nameOfCategory = "방 구하기"; // DB에 저장되는 카테고리 이름
