 ...
 * 마켓 카테고리
 */
public class Chitchat extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    final String TAG = "Chitchat";
    final String nameOfCategory = "잡담/이야기"; // DB에 저장되는 카테고리 이름
